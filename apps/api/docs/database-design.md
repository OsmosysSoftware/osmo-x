...
| max_retry_count | integer      | False    | NULL                | Maximum number of retry attempts before marking the notification as failed. When NULL, falls back to the global `MAX_RETRY_COUNT` environment variable (default: 3)                                                            |

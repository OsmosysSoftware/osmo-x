    ...
    >
      <div class="flex flex-col items-center justify-center">
        ...
        >
          ...
          >
            <div
              class="flex justify-center items-center border-2 border-pink-500 rounded-full mb-6"
              style="width: 4rem; height: 4rem"
            >
              <i class="pi pi-exclamation-circle text-pink-500" style="font-size: 1.5rem"></i>
            </div>
            ...
            <p-button label="Go to Dashboard" icon="pi pi-home" routerLink="/" severity="danger" />
          </div>
        </div>
      </div>
    </div>

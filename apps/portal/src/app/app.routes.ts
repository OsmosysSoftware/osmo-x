...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      // Configuration Routes (ORG_ADMIN or higher)
      {
        ...
        loadComponent: () =>
          import('./features/applications/pages/applications-list').then(
      ...
      },
      {
        ...
        canActivate: [orgAdminGuard],
        loadComponent: () =>
          import('./features/providers/pages/providers-list').then((m) => m.ProvidersListComponent),
      },
      {
        path: 'provider-chains',
        canActivate: [orgAdminGuard],
        loadComponent: () =>
          import('./features/provider-chains/pages/chains-list').then((m) => m.ChainsListComponent),
      },
      {
        path: 'webhooks',
        canActivate: [orgAdminGuard],
      ...
      // Super Admin Routes (SUPER_ADMIN only)
      {
        ...
        loadComponent: () =>
          import('./features/super-admin/pages/organizations-list').then(
